...
func (t *SimpleChaincode) deleteAsset(stub *shim.ChaincodeStub, args []string) ([]byte, error) {
    ...
    stateIn, err = t.intValidateInput(args)
    if err != nil {
        return nil, err
    }
...
// ************************************
func (t *SimpleChaincode) intValidateInput(args []string) (stateIn AssetState, err error) {
    var assetID string // asset ID
...
func (t *SimpleChaincode) createOrUpdateAsset(stub *shim.ChaincodeStub, args []string) ([]byte, error) {
    ...
    if err != nil || len(assetBytes)==0{
        ...
        stateStub, err =t.intMergePartialState(stateStub,stateIn)
        if err != nil {
...
/*********************************  internal: mergePartialState ****************************/	
 func (t *SimpleChaincode) intMergePartialState(oldState AssetState, newState AssetState) (AssetState,  error) {
