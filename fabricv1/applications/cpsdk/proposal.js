...
var logger = log4js.getLogger('Proposal');
...
module.exports.processProposalResults = function(tx_id, eventhub, chain, results, proposalType) {
    ...
    if (all_good) {
        ...
        var txPromise = new Promise((resolve, reject) => {
            var handle = setTimeout(reject, fabric.waitTime);
