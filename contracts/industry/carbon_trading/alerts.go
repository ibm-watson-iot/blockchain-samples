...
// RC 5 Jul 2016 Updated alert package for carbon emission
// ************************************
...
const (
     // AlertsOVERCARBON the over temperature alert 
    AlertsOVERCARBON    Alerts = 0
