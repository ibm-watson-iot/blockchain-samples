...
// 2-letter prefix.
func assetIsActive(stub shim.ChaincodeStubInterface, assetID string) ([]byte, error) {
...
func getUnmarshalledArgument(stub shim.ChaincodeStubInterface, caller string, args []string) (interface{}, error) {
    var event interface{}
    var err error
...
func getUnmarshalledState(stub shim.ChaincodeStubInterface, caller string, assetID string) (interface{}, error) {
...
func putMarshalledState(stub shim.ChaincodeStubInterface, caller string, eventName string, assetID string, state interface{}) error {
...
func addTXNTimestampToState(stub shim.ChaincodeStubInterface, caller string, state interface{}) (interface{}, error) {
    amstate, found := state.(ArgsMap)
    if !found {
        mstate, found := state.(map[string]interface{})
        if !found {
...
func addLastEventToState(stub shim.ChaincodeStubInterface, caller string, args interface{}, state interface{}, redirectedBy string) interface{} {
    amstate, found := state.(ArgsMap)
    if !found {
        mstate, found := state.(map[string]interface{})
        if !found {
...
func handleAlertsAndRules(stub shim.ChaincodeStubInterface, caller string, eventName string, assetID string, argsMap interface{}, state interface{}) (interface{}, error) {
...
func (t *SimpleChaincode) readWorldState(stub shim.ChaincodeStubInterface) ([]byte, error) {
    var err error
...
func (t *SimpleChaincode) deleteWorldState(stub shim.ChaincodeStubInterface) error {
    iter, err := stub.RangeQueryState("", "")
    if err != nil {
