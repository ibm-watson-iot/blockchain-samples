...
func (t *SimpleChaincode) createAssetAssembly(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
	return createAsset(stub, args, "assembly", "createAssetAssembly", []QualifiedPropertyNameValue{{"status", "new"}})
}

func (t *SimpleChaincode) updateAssetAssembly(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
	return updateAsset(stub, args, "assembly", "updateAssetAssembly", []QualifiedPropertyNameValue{})
}

func (t *SimpleChaincode) deleteAssetAssembly(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
	return deleteAsset(stub, args, "assembly", "deleteAssetAssembly")
}

func (t *SimpleChaincode) deleteAllAssetsAssembly(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
	return deleteAllAssets(stub, args, "assembly", "deleteAllAssetsAssembly")
}

func (t *SimpleChaincode) deletePropertiesFromAssetAssembly(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
	return deletePropertiesFromAsset(stub, args, "assembly", "deletePropertiesFromAssetAssembly", []QualifiedPropertyNameValue{})
}

func injectAircraft(stub shim.ChaincodeStubInterface, assembly interface{}) (interface{}, error) {
	var err error
...
func (t *SimpleChaincode) readAssetAssembly(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func (t *SimpleChaincode) readAllAssetsAssembly(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func (t *SimpleChaincode) readAssetAssemblyHistory(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
