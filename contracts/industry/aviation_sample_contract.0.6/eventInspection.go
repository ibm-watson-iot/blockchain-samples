...
func eventInspection(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func handleAssemblyInspectionEvent(stub shim.ChaincodeStubInterface, event interface{}) (interface{}, error) {
