...
func dynamicConfigInit(stub shim.ChaincodeStubInterface) error {
...
func getDynamicConfigFromLedger(stub shim.ChaincodeStubInterface) (DynamicContractConfig, error) {
...
func putDynamicConfigToLedger(stub shim.ChaincodeStubInterface, config DynamicContractConfig) error {
...
func updateContractConfig(stub shim.ChaincodeStubInterface, args []string) error {
...
func readContractConfig(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
	configbytes, err := stub.GetState(CONFIGSTATEKEY)
	if err != nil || len(configbytes) == 0 {
