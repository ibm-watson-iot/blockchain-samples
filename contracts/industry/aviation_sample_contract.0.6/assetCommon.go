...
func createAsset(stub shim.ChaincodeStubInterface, args []string, assetName string, caller string, inject []QualifiedPropertyNameValue) ([]byte, error) {
...
func updateAsset(stub shim.ChaincodeStubInterface, args []string, assetName string, caller string, inject []QualifiedPropertyNameValue) ([]byte, error) {
	argsMap, err := getUnmarshalledArgument(stub, caller, args)
	if err != nil {
		return nil, err
	}
...
func deletePropertiesFromAsset(stub shim.ChaincodeStubInterface, args []string, assetName string, caller string, inject []QualifiedPropertyNameValue) ([]byte, error) {
	argsMap, err := getUnmarshalledArgument(stub, caller, args)
	if err != nil {
		return nil, err
	}
...
func readAsset(stub shim.ChaincodeStubInterface, args []string, assetName string, caller string) ([]byte, error) {
	argsMap, err := getUnmarshalledArgument(stub, caller, args)
	if err != nil {
		return nil, err
	}
...
func readAllAssets(stub shim.ChaincodeStubInterface, args []string, assetName string, caller string) ([]byte, error) {
...
func readAllAssetsUnmarshalled(stub shim.ChaincodeStubInterface, args []string, assetName string, caller string) ([]interface{}, error) {
