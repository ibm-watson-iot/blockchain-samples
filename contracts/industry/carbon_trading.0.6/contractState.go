...
// v6.0 RC 14 July 2016 added trading history attributes 
// v6.1 RC 22 July 2016 added "trade" asset to store trade history
// v7.0 RC 26 July 2016 added weather, notification alerts and contact attributes
package main
...
func addAssetToContractState(stub shim.ChaincodeStubInterface, assetID string) (error) {
