...
var readWorldState as.ChaincodeFunc = func(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
	var err error
...
var deleteWorldState as.ChaincodeFunc = func(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
var setLoggingLevel as.ChaincodeFunc = func(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
// setCreateOnUpdate
// ************************************
var setCreateOnUpdate as.ChaincodeFunc = func(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func init() {
	as.AddRoute("deleteWorldState", "invoke", as.SystemClass, deleteWorldState)
	as.AddRoute("readWorldState", "query", as.SystemClass, readWorldState)
	as.AddRoute("setLoggingLevel", "invoke", as.SystemClass, setLoggingLevel)
	as.AddRoute("setCreateOnUpdate", "invoke", as.SystemClass, setCreateOnUpdate)
}
