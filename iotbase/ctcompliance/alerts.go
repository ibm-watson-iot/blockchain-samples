...
// v4.4 Aviation
// KL 29 Aug 2016 Add HARDLANDING alert and inspection action
...
const (
	// AlertsACHECK short cycle count inspection alert
	AlertsACHECK Alerts = 0
	// AlertsBCHECK long cycle count inspection alert
	AlertsBCHECK Alerts = 1
	// AlertsHARDLANDING hard landing inspection alert
	AlertsHARDLANDING Alerts = 2
...
// NewAlertStatus creates an empty alerts object
...
// AlertStatusFromMap converts incoming json object to Alert status
func AlertStatusFromMap(aMap map[string]interface{}, a AlertStatus) AlertStatus {
