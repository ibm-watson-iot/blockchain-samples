...
var log = logging.MustGetLogger("alrt")

// ExecuteRules executes all registered rules, returning true is there is an active alert
func ExecuteRules(stub *shim.ChaincodeStub, eventName string, alerts *AlertStatus, state interface{}, event interface{}) (map[string]interface{}, bool, error) {
