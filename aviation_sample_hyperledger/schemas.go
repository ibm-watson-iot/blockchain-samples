        ...
        "createAsset": {
            ...
            "properties": {
                "args": {
                    ...
                    "items": {
                        "description": "The set of writable properties that define an asset's state. For asset creation, the mandatory property 'assetID' defines a serial number or other unique identifier within its asset class. The specific event type is then selected from the objects in the 'oneOf' property. Creation and update  should include at least one writable property in addition to the assetID. This exemplifies the IoT contract pattern 'partial state as event'.",
                        "properties": {
                            "assetID": {
                            ...
                            "extension": {
                                "description": "Application managed array of extension properties. Opaque to contract.",
                                "items": {
                                    "properties": {},
                                    "type": "object"
                                },
                            ...
                            "oneOf": [
                                {
                                    "airline": {
                                        ...
                                        "properties": {
                                            "activities": {
                                                "description": "An array of activity IDs that occured for this airliine.",
                                                "items": {
                                                    "description": "The ID of a managed asset. The resource focal point for a smart contract.",
                                                    "type": "string"
                                                },
