...
// v4.4 KL Augusr 2016  Move the ASSET CRUD functions to utilsAsset, with the majority of their subtasks moved to utilsCRUD. This offers significant 
//                      reduction in the amount of repetition between separate assets when managing more than one.
