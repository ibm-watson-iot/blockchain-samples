...
func eventFlight(stub *shim.ChaincodeStub, args []string) ([]byte, error) {
...
func handleAircraftFlightEvent(stub *shim.ChaincodeStub, event interface{}) (interface{}, error) {
...
func handleAssemblyFlightEvent(stub *shim.ChaincodeStub, event interface{}, assetID string) (interface{}, error) {
	var ok bool
